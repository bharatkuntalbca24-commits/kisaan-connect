...
import { usedEquipmentListings } from '@/data/mockData';
  ...
  return (
    <section className="px-4 py-4">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <button className="flex items-center justify-center gap-2 p-4 rounded-2xl bg-gradient-to-br from-primary/20 to-primary/10 border border-primary/30 hover:border-primary/50 transition-colors">
          <ShoppingBag className="h-6 w-6 text-primary" />
          <span className="font-bold text-foreground">खरीदें</span>
        </button>
        <button className="flex items-center justify-center gap-2 p-4 rounded-2xl bg-gradient-to-br from-accent/20 to-accent/10 border border-accent/30 hover:border-accent/50 transition-colors">
      ...
      <div className="flex gap-3 overflow-x-auto scrollbar-hide pb-2 -mx-4 px-4">
        {usedEquipmentListings.map((item) => (
          <div
            key={item.id}
          ...
          >
            ...
            <div className="p-3">
              ...
              <button className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors">
